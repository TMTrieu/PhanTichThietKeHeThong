📌 Giới thiệu
Báo cáo môn học Phân tích thiết kế hệ thống với đề tài: Hệ thống Quản lý Thông tin Sinh viên Tình nguyện.
Mục tiêu chính của đề tài là xây dựng một hệ thống quản lý toàn diện cho các hoạt động tình nguyện của sinh viên, giúp quá trình đăng ký, theo dõi, quản lý và báo cáo trở nên nhanh chóng, chính xác và hiệu quả.
